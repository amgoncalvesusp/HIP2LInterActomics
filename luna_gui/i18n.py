...
# Late-created Results/Run controls. These controls are built lazily, so keep
# their placeholders and tooltips in the same catalog used by retranslate_ui.
TRANSLATIONS.update({
    "Digite para buscar o tipo": {"en": "Type to search for a type", "es": "Escriba para buscar el tipo"},
    "Digite para buscar o fingerprint": {"en": "Type to search for a fingerprint", "es": "Escriba para buscar el fingerprint"},
    "Digite para buscar a molécula": {"en": "Type to search for a molecule", "es": "Escriba para buscar una molécula"},
    "Limita quantas linhas do CSV serão mostradas na tabela para facilitar a inspeção.": {"en": "Limits the CSV rows shown in the table to make inspection easier.", "es": "Limita las filas CSV mostradas en la tabla para facilitar la inspección."},
    "Escolhe qual fingerprint calculado será exibido na tabela.": {"en": "Selects which calculated fingerprint is shown in the table.", "es": "Selecciona qué fingerprint calculado se muestra en la tabla."},
    "Escolhe qual matriz de similaridade carregada será exibida.": {"en": "Selects which loaded similarity matrix is shown.", "es": "Selecciona qué matriz de similitud cargada se muestra."},
    "Calcula e salva a matriz de similaridade a partir do fingerprint selecionado.": {"en": "Calculates and saves a similarity matrix from the selected fingerprint.", "es": "Calcula y guarda una matriz de similitud a partir del fingerprint seleccionado."},
    "Varre os resultados do projeto e gera um resumo por tipo de interação.": {"en": "Scans project results and creates a summary by interaction type.", "es": "Analiza los resultados del proyecto y crea un resumen por tipo de interacción."},
    "Calcula a matriz resíduo × ligante a partir dos resultados do projeto.": {"en": "Calculates the residue-by-ligand matrix from project results.", "es": "Calcula la matriz residuo-ligando a partir de los resultados del proyecto."},
    "Escolhe qual classe de interação será exibida no mapa de calor.": {"en": "Selects which interaction class is shown in the heatmap.", "es": "Selecciona qué clase de interacción se muestra en el mapa de calor."},
    "Recalcula o dendrograma e as atribuições de cluster com as opções escolhidas.": {"en": "Recalculates the dendrogram and cluster assignments with the selected options.", "es": "Recalcula el dendrograma y las asignaciones de cluster con las opciones elegidas."},
    "Salva uma tabela CSV com ligante, cluster e ordem hierárquica.": {"en": "Saves a CSV table with ligand, cluster, and hierarchical order.", "es": "Guarda una tabla CSV con ligando, cluster y orden jerárquico."},
    "Abre a sessão selecionada no PyMOL ou no programa associado ao sistema.": {"en": "Opens the selected session in PyMOL or the system-associated program.", "es": "Abre la sesión seleccionada en PyMOL o en el programa asociado del sistema."},
    "Abre o gráfico atual em uma janela maior para inspeção visual.": {"en": "Opens the current chart in a larger window for visual inspection.", "es": "Abre el gráfico actual en una ventana más grande para inspección visual."},
    "Valida as entradas, grava o entries.txt e inicia a execução do LUNA.": {"en": "Validates inputs, writes entries.txt, and starts the LUNA run.", "es": "Valida las entradas, escribe entries.txt e inicia la ejecución de LUNA."},
    "Interrompe a execução em andamento.": {"en": "Stops the current run.", "es": "Interrumpe la ejecución en curso."},
    "Mostra o progresso informado pelo LUNA durante a etapa atual.": {"en": "Shows the progress reported by LUNA during the current stage.", "es": "Muestra el progreso informado por LUNA durante la etapa actual."},
    "Mostra o comando efetivo usado para executar o LUNA nesta rodada.": {"en": "Shows the effective command used to run LUNA this time.", "es": "Muestra el comando efectivo usado para ejecutar LUNA en esta ejecución."},
    "Exibe o log completo da execução, incluindo mensagens do LUNA e erros.": {"en": "Displays the complete run log, including LUNA messages and errors.", "es": "Muestra el registro completo, incluidos los mensajes y errores de LUNA."},
    "Reduz o zoom do gráfico atual.": {"en": "Zooms out of the current chart.", "es": "Reduce el zoom del gráfico actual."},
    "Aumenta o zoom do gráfico atual.": {"en": "Zooms in on the current chart.", "es": "Aumenta el zoom del gráfico actual."},
    "Restaura o zoom original de 100%.": {"en": "Restores the original 100% zoom.", "es": "Restaura el zoom original al 100%."},
    "Ajusta o gráfico ao espaço disponível.": {"en": "Fits the chart to the available space.", "es": "Ajusta el gráfico al espacio disponible."},
    "Fecha a visualização ampliada.": {"en": "Closes the enlarged view.", "es": "Cierra la vista ampliada."},
    "Seleciona um arquivo de regras .cfg.": {"en": "Selects a .cfg rules file.", "es": "Selecciona un archivo de reglas .cfg."},
    "Abre o editor visual das regras de filtragem.": {"en": "Opens the visual filtering-rules editor.", "es": "Abre el editor visual de reglas de filtrado."},
    "Gera sessões PyMOL usando o filtro informado.": {"en": "Generates PyMOL sessions using the specified filter.", "es": "Genera sesiones PyMOL usando el filtro indicado."},
    "Apaga a filtragem selecionada e suas sessões geradas.": {"en": "Deletes the selected filter and its generated sessions.", "es": "Borra el filtro seleccionado y sus sesiones generadas."},
    "Atualiza todos os mapas de calor com os dados carregados.": {"en": "Updates all heatmaps with the loaded data.", "es": "Actualiza todos los mapas de calor con los datos cargados."},
    "Carrega as análises de fingerprints disponíveis no workdir.": {"en": "Loads the fingerprint analyses available in the workdir.", "es": "Carga los análisis de fingerprints disponibles en el workdir."},
    "Aplica os fingerprints informados manualmente.": {"en": "Applies the fingerprints entered manually.", "es": "Aplica los fingerprints introducidos manualmente."},
    "Usa as linhas selecionadas na tabela como fingerprints relevantes.": {"en": "Uses the selected table rows as relevant fingerprints.", "es": "Usa las filas seleccionadas como fingerprints relevantes."},
    "Restaura a seleção automática calculada pelo programa.": {"en": "Restores the automatic selection calculated by the program.", "es": "Restaura la selección automática calculada por el programa."},
    "Gera uma sessão PyMOL para o fingerprint e molécula selecionados.": {"en": "Generates a PyMOL session for the selected fingerprint and molecule.", "es": "Genera una sesión PyMOL para el fingerprint y la molécula seleccionados."},
    "Abre a sessão PyMOL selecionada.": {"en": "Opens the selected PyMOL session.", "es": "Abre la sesión PyMOL seleccionada."},
    "Clustering hierarchical": {"en": "Hierarchical clustering", "es": "Clustering jerárquico"},
    "Matrix reordered by cluster": {"en": "Matrix reordered by cluster", "es": "Matriz reordenada por cluster"},
    "Interactions by amino acid across all ligands": {"en": "Interactions by amino acid across all ligands", "pt": "Interações por aminoácido em todos os ligantes", "es": "Interacciones por aminoácido en todos los ligandos"},
    "Interactions by ligand atoms": {"en": "Interactions by ligand atoms", "pt": "Interações por átomos do ligante", "es": "Interacciones por átomos del ligando"},
    "Interaction distribution by amino acid across the complete analyzed set.": {"en": "Interaction distribution by amino acid across the complete analyzed set.", "pt": "Distribuição de interações por aminoácido em todo o conjunto analisado.", "es": "Distribución de interacciones por aminoácido en todo el conjunto analizado."},
    "Interaction distribution assigned to the participating ligand atoms across trajectory frames.": {"en": "Interaction distribution assigned to the participating ligand atoms across trajectory frames.", "pt": "Distribuição de interações atribuída aos átomos participantes do ligante ao longo dos frames da trajetória.", "es": "Distribución de interacciones asignada a los átomos participantes del ligando a través de los frames de la trayectoria."},
    "Amino acids": {"en": "Amino acids", "pt": "Aminoácidos", "es": "Aminoácidos"},
    "Ligand atoms": {"en": "Ligand atoms", "pt": "Átomos do ligante", "es": "Átomos del ligando"},
    "Interaction count": {"en": "Interaction count", "pt": "Contagem de interações", "es": "Conteo de interacciones"},
    "Interaction counts by type": {"en": "Interaction counts by type", "pt": "Contagem por tipo de interação", "es": "Conteo por tipo de interacción"},
    "% of frames (entries)": {"en": "% of frames (entries)", "pt": "% de frames (entradas)", "es": "% de frames (entradas)"},
    "Salvar relatório": {"en": "Save report", "es": "Guardar informe"},
    "Salvar relatório PDF": {"en": "Save PDF report", "es": "Guardar informe PDF"},
    "Confirmar substituição": {"en": "Confirm overwrite", "es": "Confirmar sustitución"},
    "O arquivo já existe.": {"en": "The file already exists.", "es": "El archivo ya existe."},
    "Deseja substituí-lo?": {"en": "Do you want to replace it?", "es": "¿Desea reemplazarlo?"},
    "Sim": {"en": "Yes", "es": "Sí"},
    "Não": {"en": "No", "es": "No"},
    "(opcional: config_interacoes.cfg)": {"en": "(optional: config_interacoes.cfg)", "es": "(opcional: config_interacoes.cfg)"},
    "(padrão: <workdir>/results/fingerprints/ifp.csv)": {"en": "(default: <workdir>/results/fingerprints/ifp.csv)", "es": "(predeterminado: <workdir>/results/fingerprints/ifp.csv)"},
    "(opcional: arquivo .txt com um inteiro; padrão = 0)": {"en": "(optional: .txt file with an integer; default = 0)", "es": "(opcional: archivo .txt con un entero; predeterminado = 0)"},
    "(opcional: CSV/TSV com ligand_id + coluna de rótulo)": {"en": "(optional: CSV/TSV with ligand_id + label column)", "es": "(opcional: CSV/TSV con ligand_id + columna de etiqueta)"},
    "Ex.: ligand_id, molecule_chembl_id": {"en": "E.g.: ligand_id, molecule_chembl_id", "es": "Ej.: ligand_id, molecule_chembl_id"},
    "Ex.: label, class, activity": {"en": "E.g.: label, class, activity", "es": "Ej.: label, class, activity"},
    "(padrão: <workdir>/sim_matrix_<tipo>.csv)": {"en": "(default: <workdir>/sim_matrix_<type>.csv)", "es": "(predeterminado: <workdir>/sim_matrix_<tipo>.csv)"},
    "(padrão: <workdir>/results/pse/)": {"en": "(default: <workdir>/results/pse/)", "es": "(predeterminado: <workdir>/results/pse/)"},
    "(opcional: config_interacoes.cfg)": {"en": "(optional: config_interactions.cfg)", "es": "(opcional: config_interacciones.cfg)"},
    "accept_only opcional, ex.: A/LYS/245/N*": {"en": "optional accept_only, e.g.: A/LYS/245/N*", "es": "accept_only opcional, ej.: A/LYS/245/N*"},
    "Filtrar por nome (texto livre)...": {"en": "Filter by name (free text)...", "es": "Filtrar por nombre (texto libre)..."},
    "(padrão: mesma pasta da origem)": {"en": "(default: same folder as the source)", "es": "(predeterminado: misma carpeta que el origen)"},
    "(binding_modes.cfg)": {"en": "(binding_modes.cfg)", "es": "(binding_modes.cfg)"},
    "ex.: hbonds_ligante_ativo": {"en": "e.g.: active_ligand_hbonds", "es": "ej.: hbonds_ligando_activo"},
    "IDs separados por vírgula, espaço ou quebra de linha": {"en": "IDs separated by commas, spaces, or line breaks", "es": "IDs separados por comas, espacios o saltos de línea"},
    "Digite para buscar o tipo": {"en": "Type to search for a type", "es": "Escriba para buscar el tipo"},
    "Digite para buscar o fingerprint": {"en": "Type to search for a fingerprint", "es": "Escriba para buscar el fingerprint"},
    "Digite para buscar a molécula": {"en": "Type to search for a molecule", "es": "Escriba para buscar una molécula"},
    "Pasta do projeto cujos resultados serão carregados nesta aba.": {"en": "Project folder whose results will be loaded in this tab.", "es": "Carpeta del proyecto cuyos resultados se cargarán en esta pestaña."},
    "Escolhe manualmente um workdir já processado pelo LUNA.": {"en": "Manually selects a workdir already processed by LUNA.", "es": "Selecciona manualmente un workdir ya procesado por LUNA."},
    "Lê fingerprints, matriz de similaridade e sessões PyMOL do workdir selecionado.": {"en": "Reads fingerprints, the similarity matrix, and PyMOL sessions from the selected workdir.", "es": "Lee fingerprints, la matriz de similitud y las sesiones PyMOL del workdir seleccionado."},
    "Salva a figura da aba atual em PNG, SVG ou PDF.": {"en": "Saves the current tab figure as PNG, SVG, or PDF.", "es": "Guarda la figura de la pestaña actual como PNG, SVG o PDF."},
    "Gera um relatório HTML com os principais gráficos e resumos disponíveis.": {"en": "Generates an HTML report with the main available charts and summaries.", "es": "Genera un informe HTML con los principales gráficos y resúmenes disponibles."},
    "Gera um PDF com parâmetros, explicações e interpretação básica das análises.": {"en": "Generates a PDF with parameters, explanations, and basic analysis interpretation.", "es": "Genera un PDF con parámetros, explicaciones e interpretación básica de los análisis."},
    "Escolhe o critério de ligação hierárquica usado para formar os clusters.": {"en": "Selects the hierarchical linkage criterion used to form clusters.", "es": "Selecciona el criterio de enlace jerárquico usado para formar clusters."},
    "Define em quantos grupos finais os ligantes serão separados.": {"en": "Defines how many final groups the ligands will be separated into.", "es": "Define en cuántos grupos finales se separarán los ligandos."},
    "Lista final dos agrupamentos calculados para cada ligante.": {"en": "Final list of calculated groups for each ligand.", "es": "Lista final de los grupos calculados para cada ligando."},
    "Arquivos .pse encontrados no workdir atual.": {"en": ".pse files found in the current workdir.", "es": "Archivos .pse encontrados en el workdir actual."},
    "Alterna entre o resumo total do projeto e a distribuicao por um ligante especifico.": {"en": "Switches between the project-wide summary and the distribution for one ligand.", "es": "Alterna entre el resumen total del proyecto y la distribución de un ligando."},
    "Permite reutilizar o mesmo diretório de projeto, substituindo saídas antigas.": {"en": "Allows reusing the same project directory, replacing older outputs.", "es": "Permite reutilizar el mismo directorio del proyecto, reemplazando salidas antiguas."},
    "Define quantos núcleos de CPU o LUNA pode usar na execução.": {"en": "Defines how many CPU cores LUNA can use during the run.", "es": "Define cuántos núcleos de CPU puede usar LUNA durante la ejecución."},
    "No Windows nativo, o LUNA roda com nproc=1. Para paralelismo real, use Linux ou WSL2, onde o multiprocessing usa fork.": {"en": "On native Windows, LUNA runs with nproc=1. For real parallelism, use Linux or WSL2, where multiprocessing uses fork.", "es": "En Windows nativo, LUNA se ejecuta con nproc=1. Para paralelismo real, use Linux o WSL2, donde multiprocessing usa fork."},
    "Cria ou atualiza o ambiente 'luna-env' e instala nele as dependências usadas pela GUI.": {"en": "Creates or updates the 'luna-env' environment and installs the dependencies used by the GUI.", "es": "Crea o actualiza el entorno 'luna-env' e instala las dependencias usadas por la GUI."},
    "Alterna entre o resumo total do projeto e a distribuição por um ligante específico.": {"en": "Switches between the project-wide summary and the distribution for one ligand.", "es": "Alterna entre el resumen total del proyecto y la distribución de un ligando."},
    "Oculta ou mostra todos os tipos de interação do gráfico de estatísticas.": {"en": "Hides or shows all interaction types in the statistics chart.", "es": "Oculta o muestra todos los tipos de interacción en el gráfico de estadísticas."},
    "Oculta ou mostra, de uma vez, todas as interações desfavoráveis e repulsivas no gráfico de estatísticas.": {"en": "Hides or shows all unfavorable and repulsive interactions in the statistics chart.", "es": "Oculta o muestra todas las interacciones desfavorables y repulsivas en el gráfico de estadísticas."},
    "Oculta ou mostra todos os tipos de pi-stacking/empilhamento no gráfico de estatísticas.": {"en": "Hides or shows all pi-stacking types in the statistics chart.", "es": "Oculta o muestra todos los tipos de pi-stacking en el gráfico de estadísticas."},
    "Subpastas de sessões PyMOL geradas por filtragem dinâmica.": {"en": "Subfolders of PyMOL sessions generated by dynamic filtering.", "es": "Subcarpetas de sesiones PyMOL generadas por filtrado dinámico."},
    "Arquivos .pse que passaram pela filtragem selecionada.": {"en": ".pse files that passed the selected filter.", "es": "Archivos .pse que pasaron el filtro seleccionado."},
    "Oculta ou mostra todos os tipos de interação no mapa de calor completo.": {"en": "Hides or shows all interaction types in the complete heatmap.", "es": "Oculta o muestra todos los tipos de interacción en el mapa de calor completo."},
    "Oculta ou mostra todas as interações desfavoráveis e repulsivas no mapa de calor completo.": {"en": "Hides or shows all unfavorable and repulsive interactions in the complete heatmap.", "es": "Oculta o muestra todas las interacciones desfavorables y repulsivas en el mapa de calor completo."},
    "Oculta ou mostra todos os tipos de pi-stacking/empilhamento no mapa de calor completo.": {"en": "Hides or shows all pi-stacking types in the complete heatmap.", "es": "Oculta o muestra todos los tipos de pi-stacking en el mapa de calor completo."},
    "Permite substituir a lista calculada pelo programa por fingerprints escolhidos manualmente. A escolha atualiza a tabela e os gráficos de análises FP.": {"en": "Replaces the program-calculated list with manually selected fingerprints. The choice updates the FP analysis table and charts.", "es": "Sustituye la lista calculada por el programa con fingerprints seleccionados manualmente. La selección actualiza la tabla y los gráficos de análisis FP."},
    "Usa os IDs informados como fingerprints relevantes para os gráficos abaixo.": {"en": "Uses the entered IDs as relevant fingerprints for the charts below.", "es": "Usa los IDs introducidos como fingerprints relevantes para los gráficos siguientes."},
    "Copia os IDs das linhas selecionadas da tabela para a seleção manual.": {"en": "Copies the IDs from selected table rows into the manual selection.", "es": "Copia los IDs de las filas seleccionadas a la selección manual."},
    "Volta ao critério automático de importância calculado pelo programa.": {"en": "Returns to the automatic importance criterion calculated by the program.", "es": "Vuelve al criterio automático de importancia calculado por el programa."},
})
